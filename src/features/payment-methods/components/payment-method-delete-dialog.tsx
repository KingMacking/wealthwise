...
export function PaymentMethodDeleteDialog({ open, onClose, onConfirm, isDeleting }: PaymentMethodDeleteDialogProps) {
  return (
        ...
        <AlertDialogHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <AlertDialogDescription>
                Vas a eliminar este método de pago. Esta acción no se puede deshacer.
              </AlertDialogDescription>
            </div>
          </div>
        </AlertDialogHeader>
